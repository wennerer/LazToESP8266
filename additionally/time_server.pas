unit time_server;
(* Diese Unit stammt ursprünglich von ccrause und wurde von mir etwas verändert
   siehe: https://github.com/ccrause/fpc-esp-freertos/blob/master/examples/boreholepump/timeunit.pas *)
...
procedure initTime;
begin
  //angepasst an Deutschland mit Sommer- und Winterzeit!
  ...
  sntp_setservername(3, '3.de.pool.ntp.org');
